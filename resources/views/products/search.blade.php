...
@section('content')
    ...
    <div class="container">
        <div class="row">
            <p class="text">搜尋結果({{ $search_records }})</p>
        </div>
        <div class="row">
            ...
            <p class="text02">
                共
                <font color="blue">{{ $search_records }}</font>
                件產品
            </p>
            <hr>
        </div>
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="thumbnail">
                    <img src="{{ asset($search->photo) }}">
                    <div class="caption" align="center">
                        <h3>{{ $search->name }} </h3>
                        <p>{{ $search->detail }}</p>
                        <form action="{{ route('products.show', $search->id) }}" role="button" method="GET">
                            @method('GET')
                            @csrf
